...
C      DATA SMALL(2), SMALL(1) / Z'00100000', Z'00000000' /
C      DATA LARGE(2), LARGE(1) / Z'7FEFFFFF', Z'FFFFFFFF' /
C      DATA RIGHT(2), RIGHT(1) / Z'3CA00000', Z'00000000' /
C      DATA DIVER(2), DIVER(1) / Z'3CB00000', Z'00000000' /
C      DATA LOG10(2), LOG10(1) / Z'3FD34413', Z'509F79FF' /

      IF (I .LT. 1 .OR. I .GT. 5) WRITE(6,500)
  500 FORMAT(' ERROR IN D1MACH - I OUT OF BOUNDS')
C
      D1MACH = DMACH(I)
      RETURN
C
