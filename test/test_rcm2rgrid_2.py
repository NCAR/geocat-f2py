...
fo_nom_expected = np.asarray([
    1.870327, 1.353965, 1.931963, 1.872924, 0.8730035, -0.1676207, 2.946794, 0.1410671,
    1.917912, 1.98253, 1.877125, 1.735453, -1.82497, 1.177423, 2.169137, 1.01385,
    0.381366, 0.3293635, 1.053591, 2.015617, 0.6676366, 1.754721, 0.4975608, 2.691788
]).reshape((2, 4, 3))

fo_nan_expected = np.asarray([
    2.439301, 1.353965, 1.931963, 1.872924, 0.8730035, -0.1676207, 2.946794, 0.1410671,
    np.nan, 1.98253, 1.877125, 1.735453, -1.82497, 1.177423, 2.169137, 1.01385,
    0.381366, 0.3293635, 1.053591, 2.015617, 0.6676366, 1.754721, 0.4975608, np.nan
]).reshape((2, 4, 3))

fo_msg_expected = np.asarray([
    2.439301, 1.353965, 1.931963, 1.872924, 0.8730035, -0.1676207, 2.946794, 0.1410671,
    -99, 1.98253, 1.877125, 1.735453, -1.82497, 1.177423, 2.169137, 1.01385,
    0.381366, 0.3293635, 1.053591, 2.015617, 0.6676366, 1.754721, 0.4975608, -99
]).reshape((2, 4, 3))
