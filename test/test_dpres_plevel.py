...
# Expected Output
# Pressure levels (Pa)
pressure_levels = np.array([1000., 950., 900., 850., 800., 750., 700., 650., 600.,
...
pressure_surface_2d = np.array([1018.0, 1016.0, 1014.0, 1012.0]).reshape(2, 2)   # Units of Pa
...
expected_dp_psfc_scalar = np.array([4300., 5000., 5000., 5000., 5000., 5000., 5000., 5000.,
                                    5000., 5000., 5000., 5000., 5000., 5000., 5000., 5000.,
                                    3750., 2500., 2500., 2500., 2250., 1500., 1000., 1000.,
                                    1000., 1000., 750., 500., 750., 500.])

# for 2D pressure_surface
expected_dp_psfc_2d     = np.array([4300., 4100., 3900., 3700., 5000., 5000., 5000., 5000.,
                                    5000., 5000., 5000., 5000., 5000., 5000., 5000., 5000.,
                                    5000., 5000., 5000., 5000., 5000., 5000., 5000., 5000.,
                                    5000., 5000., 5000., 5000., 5000., 5000., 5000., 5000.,
                                    5000., 5000., 5000., 5000., 5000., 5000., 5000., 5000.,
                                    ...
                                    5000., 5000., 5000., 5000., 5000., 5000., 5000., 5000.,
                                    5000., 5000., 5000., 5000., 5000., 5000., 5000., 5000.,
                                    3750., 3750., 3750., 3750., 2500., 2500., 2500., 2500.,
                                    2500., 2500., 2500., 2500., 2500., 2500., 2500., 2500.,
                                    2250., 2250., 2250., 2250., 1500., 1500., 1500., 1500.,
                                    1000., 1000., 1000., 1000., 1000., 1000., 1000., 1000.,
                                    1000., 1000., 1000., 1000., 1000., 1000., 1000., 1000.,
                                    750.,  750.,  750.,  750.,  500.,  500.,  500.,  500.,
                                    750.,  750.,  750.,  750.,  500.,  500.,  500.,  500.]).reshape(30,2,2)
...
class Test_dpres_plevel_float32_psfc_scalar(ut.TestCase):
    def test_dpres_plevel_float32(self):
        ...
        result_dp = geocat.f2py.dpres_plevel(plev_asfloat32, pressure_surface_scalar)
        nt.assert_array_equal(expected_dp_psfc_scalar, result_dp.values)

class Test_dpres_plevel_float32_psfc_2d(ut.TestCase):
    def test_dpres_plevel_float32(self):
        result_dp = geocat.f2py.dpres_plevel(pressure_levels_asfloat32, pressure_surface_2d_asfloat32)
        nt.assert_array_equal(expected_dp_psfc_2d, result_dp.values)

    def test_dpres_plevel_float32_msg_nan(self):
        result_dp = geocat.f2py.dpres_plevel(pressure_levels_asfloat32, pressure_surface_2d_nan_asfloat32)
        asd = np.sum(result_dp.values != expected_dp_psfc_2d_msg_nan)
        nt.assert_array_almost_equal(expected_dp_psfc_2d_msg_nan, result_dp.values)

    def test_dpres_plevel_float32_msg_99(self):
        result_dp = geocat.f2py.dpres_plevel(pressure_levels_asfloat32, pressure_surface_2d_msg_asfloat32, msg_py=-99)
        nt.assert_array_equal(expected_dp_psfc_2d_msg_99, result_dp.values)
